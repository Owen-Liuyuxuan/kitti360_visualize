...
class RosInterface(object):
    def __init__(self):
        ...
        self.index_pub = rospy.Publisher("/kitti360/control/index", Int32, queue_size=1)
        self.pause_pub = rospy.Publisher("/kitti360/control/pause", Bool, queue_size=1)
        self.stop_pub = rospy.Publisher("/kitti360/control/stop", Bool, queue_size=1)
